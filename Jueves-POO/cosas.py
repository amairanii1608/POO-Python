class Autor:
    ...
    def __str__(self):
        return f"Nombre: {self.nombre}, pseudónimo: {self.pseudonimo}"

    def escribit(self):
        print(f"{self.pseudonimo} está escribiendo su siguiente obra")
...
class Alumno(Persona):
    def __init__(self, nombre, edad, nume_cuenta, carrera, promedio):
